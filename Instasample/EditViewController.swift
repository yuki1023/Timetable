...
//        loadData()
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if subjectArray[indexPath.row].object(forKey: "className") as! String == ""{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let AddSubjectViewController = segue.destination as! AddSubjectViewController
            ...
            AddSubjectViewController.passedIndexData = selectedIndex.row
        ...
        if segue.identifier == "toEdit" {
            ...
            EditSubjectViewController.passedData = subjectArray[selectedIndex.row] as! NCMBObject
